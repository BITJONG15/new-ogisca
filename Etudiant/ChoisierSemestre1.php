...
<body class="bg-gray-100 font-sans">
  ...
  <div
    id="sidebar"
    class="fixed top-0 left-0 h-full w-64 text-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50"
    aria-label="Sidebar menu"
  >
    <h1 class="text-2xl font-bold mb-6 px-6 select-none">OGISCA</h1>
    <nav class="flex flex-col mt-4 space-y-2 px-4" role="menu">
      <a
        href="AccueilEtudiant.php"
        class="nav-link flex items-center gap-3 rounded-md px-3 py-2 focus:outline-none active-link"
        role="menuitem"
        tabindex="0"
        aria-current="page"
      ...
      <a
        ...
        class="nav-link flex items-center gap-3 rounded-md px-3 py-2 focus:outline-none"
        role="menuitem"
        tabindex="-1"
  ...
  <div class="md:ml-64 pt-16">
    ...
    <main class="p-4">
      ...
      <div class="flex justify-center gap-4 mb-6">
        <a href="ChoisierSemestre1.php" class="bg-blue-700 text-white font-semibold px-4 py-2 rounded-md">Semestre 1</a>
        <a href="ChoisirSemestre2.php" class="bg-blue-100 text-blue-700 font-semibold px-4 py-2 rounded-md">Semestre 2</a>
      </div>
  ...
  <script>
    ...
    // Gestion navigation clavier dans sidebar
